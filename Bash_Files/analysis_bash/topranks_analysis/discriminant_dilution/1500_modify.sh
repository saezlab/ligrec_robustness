...
#SBATCH --mem=20000
#SBATCH --job-name="1500_modify"
#SBATCH --output=1500_modify.out
...
/net/data.isilon/ag-saez/bq_pburmedi/SOFTWARE/miniconda3/envs/liana_env/bin/Rscript Code/Analysis_Scripts/Resources_Run_Iterator.R TRUE "variable" 1500 $SLURM_JOBID FALSE 
